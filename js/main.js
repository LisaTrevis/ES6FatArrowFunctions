...
// If all the function does is return a single line of code, you can just write what is being returned and don't have to use the return key word, like this:
...
// Arguments can be given default values in ES6:

// var fn = (a = 4, b = 10) => a + b

// console.log(fn())

// Also helpful with callback functions:
